...
class MultiTaskPerceptionModel(nn.Module):
    ...
    Loads pretrained weights from:
      - checkpoints/classifier.pth  (VGG11Classifier state dict)
      - checkpoints/localizer.pth   (VGG11Localizer state dict)
      - checkpoints/unet.pth        (VGG11UNet state dict)
...
def _load_checkpoints(self):
    ...
    def forward(self, x: torch.Tensor):
        ...
        Returns:
            ...
            - 'localization':   [B, 4] (x_center, y_center, w, h) in pixel space.
