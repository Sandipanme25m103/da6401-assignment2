...
class DecoderBlock(nn.Module):
    """U-Net decoder block: upsample + skip connection + 2 convs.
...
class VGG11UNet(nn.Module):
    """U-Net segmentation with VGG11 encoder backbone.

    Args:
        num_classes: segmentation classes (default 3 for Pet trimap).
